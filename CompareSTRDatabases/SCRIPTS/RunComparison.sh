...
intervene venn --names=PathogenicLoci,GangSTR,STRetch --type genomic \
	...
	-i  PathogenicLoci_hg19_20190708.bed hg19_ver13_1.bed  hg19.simpleRepeat_period1-6_dedup.sorted.bed
...
intervene venn --names=PathogenicLoci,GangSTR,STRetch --type genomic \
	...
	-i PathogenicLoci_hg19_20190708.bed hg19_ver13_1_2-6filtered.bed hg19.simpleRepeat_period1-6_dedup.sorted_2-6filtered.bed  
