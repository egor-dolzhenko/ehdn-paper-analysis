...
do
    ...
    cat $TEMPLATE | \
        ...
        > $PBSDIR/diversity/EHdn_0.8.6_$BASE.pbs
    echo "qsub EHdn_0.8.6_$BASE.pbs" >> $PBSDIR/diversity_submit.sh
done
...
do
    ...
    cat $TEMPLATE | \
        ...
        > $PBSDIR/repeatexpansions/EHdn_0.8.6_$BASE.pbs
    echo "qsub EHdn_0.8.6_$BASE.pbs" >> $PBSDIR/repeatexpansions_submit.sh
done
