...
PBSDIR=$BASEDIR/scripts/pbs/EHdn_0.8.0

TEMPLATE=$BASEDIR/scripts/template_EHdn_0.8.0.sh
...
do
    ...
    cat $TEMPLATE | \
        ...
        > $PBSDIR/diversity/EHdn_0.8.0_$BASE.pbs
    echo "qsub EHdn_0.8.0_$BASE.pbs" >> $PBSDIR/diversity_submit.sh
done
...
do
    ...
    cat $TEMPLATE | \
        ...
        > $PBSDIR/repeatexpansions/EHdn_0.8.0_$BASE.pbs
    echo "qsub EHdn_0.8.0_$BASE.pbs" >> $PBSDIR/repeatexpansions_submit.sh
done
