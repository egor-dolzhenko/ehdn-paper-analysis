...
FASTADIR=/home/richmonp/project/RICHMOND/SIMULATION/STR_SIM/STR_Analysis/STR_Simulation/str_fastas/
WRITE_DIR=/home/richmonp/project/RICHMOND/SIMULATION/STR_SIM/STR_Analysis/STR_Simulation/str_bams/
...
do
	...
	#Map with BWA
	bwa mem $BWA_INDEX -t $NSLOTS -R "@RG\tID:STR_SIM\tSM:STR_SIM\tPL:illumina" -M $FASTQR1 $FASTQR2 > $WORKING_DIR$SAMPLE_ID.sam
