...
STR_TABLE=$STR_ANALYSIS_DIR/CompareSTRDatabases/PathogenicLoci_GRCh37_20191023_table_Simple.tsv
...
FASTADIR=${STR_ANALYSIS_DIR}STR_Simulation/str_fastas/GRCh37_20191030/
mkdir -p $FASTADIR
...
BAMDIR=$STR_ANALYSIS_DIR/STR_Simulation/str_bams/GRCh37_20191030/
mkdir -p $BAMDIR
WORKING_DIR=$BAMDIR
cd $WORKING_DIR
