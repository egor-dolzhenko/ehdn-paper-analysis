...
#PBS -A st-wasserww-1
#PBS -V
#PBS -N SetupSTR_Sim_Pathogenic_Complex
#PBS -m bea
...
STR_TABLE=$STR_ANALYSIS_DIR/CompareSTRDatabases/PathogenicLoci_Complex_GRCh37_20191118_table.tsv
# EHdn Executables
...
FASTADIR=${STR_ANALYSIS_DIR}STR_Simulation/str_fastas/GRCh37_Complex_20191118/
mkdir -p $FASTADIR
...
BAMDIR=$STR_ANALYSIS_DIR/STR_Simulation/str_bams/GRCh37_Complex_20191120/
mkdir -p $BAMDIR
WORKING_DIR=$BAMDIR
cd $WORKING_DIR
