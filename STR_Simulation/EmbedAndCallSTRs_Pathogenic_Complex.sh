...
#PBS -A st-wasserww-1
#PBS -V
#PBS -N STR_Surgery_NonPathogenic_Complex
#PBS -m bea
...
OUTPUT_DIR=/scratch/st-wasserww-1/STR_SIM/Complex_20191122/
mkdir -p $OUTPUT_DIR
cd $OUTPUT_DIR

# Set the CUTOUT, and STR_BAM Directory based on where this repo is cloned
CUTOUT_BED_DIR=$STR_ANALYSIS_DIR/STR_Simulation/str_fastas/GRCh37_Complex_20191122/
STR_BAM_DIR=$STR_ANALYSIS_DIR/STR_Simulation/str_bams/GRCh37_Complex_20191122/
