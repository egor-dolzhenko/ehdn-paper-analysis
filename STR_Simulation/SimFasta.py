...
def GetArgs():
	...
	parser.add_argument("-C","--Complex",help="These are complex STRs",action='store_true',default=False)
...
def Simulate(tableinfile,outputdirectory,sizes,window,fasta,Complex):
...
def Main():
	...
	Simulate(ARGS.Table,ARGS.Directory,SizeRanges,WindowSize,ARGS.Fasta,ARGS.Complex)
