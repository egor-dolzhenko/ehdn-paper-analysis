...
#PBS -A st-wasserww-1
#PBS -V
#PBS -N DiversityCohort_EHDN_pipeline_CombineCompareOutlier
#PBS -m bea
#PBS -V
...
SAMPLE_DIR=/scratch/st-wasserww-1/POLARIS_JSONS/EHdn_Diversity_0.8.6_PolarisForAnalysis/
WORKING_DIR=/scratch/st-wasserww-1/POLARIS_JSONS/EHdn_Diversity_0.8.6_PolarisForAnalysis/
