...
#PBS -A st-wasserww-1
#PBS -V
#PBS -N PathoSmall_EHDN_pipeline_CombineCompareOutlier
#PBS -m bea
#PBS -V
...
SAMPLE_DIR=/scratch/st-wasserww-1/STR_SIM/PathoSmall/
WORKING_DIR=/scratch/st-wasserww-1/STR_SIM/PathoSmall/
...
cd $WORKING_DIR
JSON_FILES=( $SAMPLE_DIR/AR_*.str_profile.json ) 
