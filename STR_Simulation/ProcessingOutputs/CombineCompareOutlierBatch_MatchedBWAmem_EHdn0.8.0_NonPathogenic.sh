...
SAMPLE_DIR=/scratch/st-wasserww-1/NonPathogenic/
WORKING_DIR=/scratch/st-wasserww-1/NonPathogenic/
POLARIS_DIR=/scratch/st-wasserww-1/POLARIS_JSONS/bwamem/EHdn_0.8.0/diversity
GENOME_FASTA=/project/st-wasserww-1/GENOME/GRCh37/GRCh37-lite.fa

source activate EHDN

cd $WORKING_DIR
JSON_FILES=( $SAMPLE_DIR/*EHDN.str_profile.json ) 
