...
#PBS -A st-wasserww-1
#PBS -V
#PBS -N VNTR_EHDN_pipeline_CombineCompareOutlier
#PBS -m bea
#PBS -V
...
SAMPLE_DIR=/scratch/st-wasserww-1/STR_SIM/Finished20191115/NonPathoSTR/
WORKING_DIR=/scratch/st-wasserww-1/STR_SIM/Finished20191115/NonPathoSTR/
