...
#PBS -A st-wasserww-1
#PBS -V
#PBS -N PathoLarge_EHDN_pipeline_CombineCompareOutlier
#PBS -m bea
#PBS -V
...
SAMPLE_DIR=/scratch/st-wasserww-1/STR_SIM/PathoLarge/
WORKING_DIR=/scratch/st-wasserww-1/STR_SIM/PathoLarge/
