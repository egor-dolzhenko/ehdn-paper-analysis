# Align using bowtie2 in end to end mode
...
OUTDIR=$BASEDIR/bam_compare_aligners/bowtie2_endtoend
...
$BOWTIE2 -p $THREADS -x $REF -1 $FQ1 -2 $FQ2 --end-to-end > $OUTDIR/$BASE.sam
